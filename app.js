document.addEventListener("DOMContentLoaded", iniciarStarPicks);

function iniciarStarPicks() {

    console.log("StarPicks conectado a Firebase…");
    ...
    import("https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js").then(module => {
        ...
        const { collection, addDoc, getDocs, updateDoc, deleteDoc, doc } = module;
